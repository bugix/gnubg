...
extern void drawPiece(const ModelManager* modelHolder, const BoardData3d* bd3d, unsigned int point, unsigned int pos, int rotate, int roundPiece, unsigned int curveAccuracy, int separateTop);
...
extern void renderFlag(const ModelManager* modelHolder, const BoardData3d* bd3d, unsigned int curveAccuracy, int turn, int resigned);
...
extern void MAApiece(int roundPiece, unsigned int curveAccuracy);
